    ...
    it('【変化有り】全ての棋譜をパースして決められた形式のオブジェクトで返す', function() {
      ...
      var comp = {'main':[
        ...
        {'move':{'turn': false, 'to':[8,5],'from':[8,4],'piece':1},
         'time':0},
        {'move':{'turn': true, 'to':[2,4],'from':[2,5],'piece':1},
         'time':0},
        {'move':{'turn': false, 'to':[2,4],'from':[2,3],'piece':1},
         'time':0},
        {'move':{'turn': true, 'to':[2,4],'from':[2,8],'piece':7},
         'time':0}],
                  'variations':[[4,[{'move':{'turn': false, 'to':[4,4],'from':[4,3],'piece':1},
                                    'time':0},
                                    {'move':{'turn': true, 'to':[2,5],'from':[2,6],'piece':1},
                                     'time':0},
                                    {'special':'%CHUDAN'}]],
                                [2,[{'move':{'turn': false, 'to':[8,4],'from':[8,3],'piece':1},
                                     'time':0},
                                    {'move':{'turn': true, 'to':[3,6],'from':[3,7],'piece':1},
                                     'time':0},
                                    {'special':'%CHUDAN'}]],
                                [1,[{'move':{'turn': true, 'to':[2,6],'from':[2,7],'piece':1},
                                     'time':0},
                                    {'move':{'turn': false, 'to':[8,4],'from':[8,3],'piece':1},
                                     'time':0},
                                    {'special':'%CHUDAN'}]
